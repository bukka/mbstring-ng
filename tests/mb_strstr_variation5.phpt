--TEST--
Test mb2_strstr() function : variation - multiple needles
--SKIPIF--
<?php
...
echo "-- Ascii data --\n";
var_dump(bin2hex(mb2_strstr($string_ascii, $needle_ascii, false)));
var_dump(bin2hex(mb2_strstr($string_ascii, $needle_ascii, true)));

echo "-- mb data in utf-8 --\n";
$res = mb2_strstr($string_mb, $needle_mb, false);
if ($res !== false) {
...
$res = mb2_strstr($string_mb, $needle_mb, true);
if ($res !== false) {
    var_dump(bin2hex($res));
}
else {
