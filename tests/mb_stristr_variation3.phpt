--TEST--
Test mb2_stristr() function : usage variation - different values for part
--SKIPIF--
<?php
...
foreach($inputs as $key =>$value) {
      echo "\n--$key--\n";
      $res = mb2_stristr($haystack, $needle, $value, $encoding);
      if ($res === false) {
         var_dump($res);
      }
      else {
...
--empty array--
Error: 2 - mb2_stristr() expects parameter 3 to be boolean, array given, %s(%d)
bool(false)
...
Error: 2 - mb2_stristr() expects parameter 3 to be boolean, object given, %s(%d)
bool(false)
...
--resource--
Error: 2 - mb2_stristr() expects parameter 3 to be boolean, resource given, %s(%d)
bool(false)
===DONE===
