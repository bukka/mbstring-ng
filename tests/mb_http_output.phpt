...
$r = mb2_http_output('BAD_NAME');
($r === FALSE) ? print "OK_BAD_SET\n" : print "NG_BAD_SET\n";
$enc = mb2_http_output();
print "$enc\n";

$r = mb2_http_output($t_ary);
($r === FALSE) ? print "OK_BAD_ARY_SET\n" : print "NG_BAD_ARY_SET\n";
$enc = mb2_http_output();
print "$enc\n";

$r = mb2_http_output($t_obj);
