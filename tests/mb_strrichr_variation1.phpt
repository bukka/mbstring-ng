--TEST--
Test mb2_strrichr() function : usage variation - various haystacks, needle won't be found
--SKIPIF--
<?php
...
foreach($inputs as $key =>$value) {
      echo "\n--$key--\n";
      var_dump( mb2_strrichr($value, $needle, $part, $encoding) );
};
...
--empty array--
Error: 2 - mb2_strrichr() expects parameter 1 to be string, array given, %s(%d)
bool(false)
...
Error: 2 - mb2_strrichr() expects parameter 1 to be string, object given, %s(%d)
bool(false)
...
--resource--
Error: 2 - mb2_strrichr() expects parameter 1 to be string, resource given, %s(%d)
bool(false)
===DONE===
