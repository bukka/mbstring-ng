--TEST--
Test mb2_strrpos() function : usage variations - pass different data types to $haystack arg
--SKIPIF--
<?php
...
/*
 * Pass mb2_strrpos() different data types as $haystack argument to test behaviour
 */
...
foreach($inputs as $input) {
  echo "\n-- Iteration $iterator --\n";
  var_dump( mb2_strrpos($input, $needle, $offset, $encoding));
  $iterator++;
};
...
Warning: mb2_strrpos() expects parameter 1 to be string, resource given in %s on line %d
bool(false)
Done