--TEST--
Test mb2_strripos() function : usage variations - pass different data types to $haystack arg
--SKIPIF--
<?php
...
/*
 * Pass mb2_strripos different data types as $haystack arg to test behaviour
 */
...
foreach($inputs as $input) {
  echo "\n-- Iteration $iterator --\n";
  var_dump( mb2_strripos($input, $needle, $offset, $encoding));
  $iterator++;
};
...
Warning: mb2_strripos() expects parameter 1 to be string, resource given in %s on line %d
bool(false)
Done