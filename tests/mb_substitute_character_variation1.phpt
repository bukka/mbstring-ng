--TEST--
Test mb2_substitute_character() function : usage variation 
--SKIPIF--
<?php
...
echo "*** Testing mb2_substitute_character() : usage variation ***\n";
...
foreach($inputs as $key =>$value) {
      echo "\n--$key--\n";
      var_dump( mb2_substitute_character($value) );
};
...
===DONE===
--EXPECTF--
*** Testing mb2_substitute_character() : usage variation ***

--int 0--
Error: 2 - mb2_substitute_character(): Unknown character., %s(%d)
bool(false)
