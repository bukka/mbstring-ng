--TEST--
Test mb2_ereg_replace() function : usage variations  
--SKIPIF--
<?php
...
foreach($inputs as $input) {
      echo "\n-- Iteration $iterator --\n";
      var_dump( mb2_ereg_replace($pattern, $replacement, $string, $input) );
      $iterator++;
};
...
Warning: mb2_ereg_replace() expects parameter 4 to be string, resource given in %s on line %d
bool(false)
Done