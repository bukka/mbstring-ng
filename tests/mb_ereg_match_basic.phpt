--TEST--
Test mb2_ereg_match() function : basic functionality
--SKIPIF--
<?php
...
var_dump(mb2_ereg_match($regex1, $string_mb, b'i'));

echo "\n-- Multibyte string 2 --\n";
$regex2 = base64_decode('5LiW55WM');
var_dump(mb2_ereg_match($regex2, $string_mb));

echo "Done";
?>
--EXPECTF--

*** Testing mb2_ereg_match() : basic functionality ***
