--TEST--
Test mb2_ereg() function : usage variations - different regex features in $pattern
--SKIPIF--
<?php
...
var_dump(mb2_ereg($regex_ascii, $string_ascii, $regs_ascii));
...
var_dump(mb2_ereg($regex_mb, $string_mb, $regs_mb));
