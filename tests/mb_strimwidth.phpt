...
print  "1: ". mb2_strimwidth($euc_jp,  0, 15,'...','EUC-JP') . "\n";
print  "2: ". mb2_strimwidth($euc_jp,  0, 100,'...','EUC-JP') . "\n";
print  "3: ". mb2_strimwidth($euc_jp, 15, 100,'...','EUC-JP') . "\n";
// Note: Did not start form -22 offset. Staring from 0.
$str = mb2_strimwidth($euc_jp,-22, 100,'...','EUC-JP');
($str === FALSE) ? print "4 OK\n" : print "NG: $str\n";

$str = mb2_strimwidth($euc_jp, 100, -10,'...','EUC-JP');
