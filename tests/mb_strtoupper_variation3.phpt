--TEST--
Test mb2_strtoupper() function : usage varitations - pass mixed ASCII and non-ASCII strings
--SKIPIF--
<?php
...
$a = mb2_strtoupper($string_mixed_lower, 'UTF-8');
...
$b = mb2_strtoupper($string_all_mb, 'UTF-8');
