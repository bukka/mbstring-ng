--TEST--
Test mb2_strrchr() function : variation - case sensitivity
--SKIPIF--
<?php
...
var_dump(bin2hex(mb2_strrchr($string_ascii, $needle_ascii_lower)));
// no needle should be found
var_dump(mb2_strrchr($string_ascii, $needle_ascii_upper));
var_dump(mb2_strrchr($string_ascii, $needle_ascii_mixed));

echo "-- mb data in utf-8 --\n";
// needle should be found
$res = mb2_strrchr($string_mb, $needle_mb2_lower, false);
if ($res !== false) {
...
// no needle should be found
var_dump(mb2_strrchr($string_mb, $needle_mb2_upper));
var_dump(mb2_strrchr($string_mb, $needle_mb2_mixed));
