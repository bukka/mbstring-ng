--TEST--
Test mb2_encode_mimeheader() function : usage variations - Pass different data types to $linefeed arg
--SKIPIF--
<?php
...
/*
 * Pass different data types to $linefeed argument to see how mb2_encode_mimeheader() behaves
 */
...
foreach($inputs as $input) {
  echo "\n-- Iteration $iterator --\n";
  var_dump( mb2_encode_mimeheader($str, $charset, $transfer_encoding, $input, $indent));
  $iterator++;
};
...
Warning: mb2_encode_mimeheader() expects parameter 4 to be string, resource given in %s on line %d
NULL
Done
