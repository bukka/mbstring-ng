--TEST--
Test mb2_encode_mimeheader() function : basic functionality, indent
--SKIPIF--
<?php
...
echo "*** Testing mb2_encode_mimeheader() : indent ***\n";
...
for ($i = 0; $i < 100; $i++) {
  echo "\n-- Iteration $i --\n";
  var_dump( mb2_encode_mimeheader($str, $charset, "B", $linefeed, $i));
  var_dump( mb2_encode_mimeheader($str, $charset, "Q", $linefeed, $i));  
};
echo "Done";
?>
--EXPECT--
*** Testing mb2_encode_mimeheader() : indent ***
