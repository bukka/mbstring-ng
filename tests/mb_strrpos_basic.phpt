--TEST--
Test mb2_strrpos() function : basic functionality
--SKIPIF--
<?php
...
/*
 * Test basic functionality of mb2_strrpos()
 */

echo "*** Testing mb2_strrpos() : basic ***\n";
...
echo "\n-- ASCII string 1 --\n";
var_dump(mb2_strrpos($string_ascii, b'is', 4, 'ISO-8859-1'));

echo "\n-- ASCII string 2 --\n";
var_dump(mb2_strrpos($string_ascii, b'hello, world'));

echo "\n-- Multibyte string 1 --\n";
$needle1 = base64_decode('44CC');
var_dump(mb2_strrpos($string_mb, $needle1));

echo "\n-- Multibyte string 2 --\n";
$needle2 = base64_decode('44GT44KT44Gr44Gh44Gv44CB5LiW55WM');
var_dump(mb2_strrpos($string_mb, $needle2));

echo "Done";
?>
--EXPECTF--
*** Testing mb2_strrpos() : basic ***
