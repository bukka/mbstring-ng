--TEST--
Test mb2_decode_mimeheader() function : basic functionality 
--SKIPIF--
<?php
...
echo "*** Testing mb2_decode_mimeheader() : basic functionality ***\n";
...
===DONE===
--EXPECT--
*** Testing mb2_decode_mimeheader() : basic functionality ***
