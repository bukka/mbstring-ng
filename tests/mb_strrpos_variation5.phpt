--TEST--
Test mb2_strrpos() function : usage variations - pass encoding as third argument (deprecated behaviour)
--SKIPIF--
<?php
...
foreach ($inputs as $type => $input) {
	...
	var_dump(mb2_strrpos($string_mb, $needle_mb, $input, 'utf-8'));
	echo "-- Without fourth encoding argument --\n";
	var_dump(mb2_strrpos($string_mb, $needle_mb, $input));
}
