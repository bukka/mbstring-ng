--TEST--
Test mb2_convert_encoding() function : basic functionality 
--SKIPIF--
<?php
...
/*
 * Test basic functionality of mb2_convert_encoding()
 */

echo "*** Testing mb2_convert_encoding() : basic functionality ***\n";
...
var_dump(base64_encode(mb2_convert_encoding($sjis_string, 'JIS', 'SJIS')));
var_dump(base64_encode(mb2_convert_encoding($euc_jp_string, 'JIS', 'EUC-JP')));
var_dump(base64_encode(mb2_convert_encoding($utf8_string, 'JIS', 'UTF-8')));

echo "\n-- Convert to EUC-JP --\n";
echo "EUC-JP encoded string in base64:\n";
var_dump(base64_encode($euc_jp_string));
echo "Converted Strings:\n";
var_dump(base64_encode(mb2_convert_encoding($sjis_string, 'EUC-JP', 'SJIS')));
var_dump(base64_encode(mb2_convert_encoding($jis_string, 'EUC-JP', 'JIS')));
var_dump(base64_encode(mb2_convert_encoding($utf8_string, 'EUC-JP', 'UTF-8')));

echo "\n-- Convert to SJIS --\n";
echo "SJIS encoded string in base64:\n";
var_dump(base64_encode($sjis_string));
echo "Converted Strings:\n";
var_dump(base64_encode(mb2_convert_encoding($jis_string, 'SJIS', 'JIS')));
var_dump(base64_encode(mb2_convert_encoding($euc_jp_string, 'SJIS', 'EUC-JP')));
var_dump(base64_encode(mb2_convert_encoding($utf8_string, 'SJIS', 'UTF-8')));

echo "\n-- Convert to UTF-8 --\n";
echo "UTF-8 encoded string in base64:\n";
var_dump(base64_encode($utf8_string));
echo "Converted Strings:\n";
var_dump(base64_encode(mb2_convert_encoding($sjis_string, 'UTF-8', 'SJIS')));
var_dump(base64_encode(mb2_convert_encoding($jis_string, 'UTF-8', 'JIS')));
var_dump(base64_encode(mb2_convert_encoding($euc_jp_string, 'UTF-8', 'EUC-JP')));

echo "Done";
?>
--EXPECTF--
*** Testing mb2_convert_encoding() : basic functionality ***
