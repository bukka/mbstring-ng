...
// EUC-JP
$r = mb2_internal_encoding('EUC-JP');
($r === TRUE) ? print "OK_EUC-JP_SET\n" : print "NG_EUC-JP_SET\n";
$enc = mb2_internal_encoding();
print "$enc\n";

// UTF-8
$r = mb2_internal_encoding('UTF-8');
($r === TRUE) ? print "OK_UTF-8_SET\n" : print "NG_UTF-8_SET\n";
$enc = mb2_internal_encoding();
print "$enc\n";

// ASCII
$r = mb2_internal_encoding('ASCII');
...
$r = mb2_internal_encoding('BAD');
($r === FALSE) ? print "OK_BAD_SET\n" : print "NG_BAD_SET\n";
$enc = mb2_internal_encoding();
print "$enc\n";

$r = mb2_internal_encoding($t_ary);
($r === FALSE) ? print "OK_BAD_ARY_SET\n" : print "NG_BAD_ARY_SET\n";
$enc = mb2_internal_encoding();
print "$enc\n";

$r = mb2_internal_encoding($t_obj);
