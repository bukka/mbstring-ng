--TEST--
Test mb2_substr_count() function : variation - pass a $needle that overlaps in $haystack
--SKIPIF--
<?php
...
/*
 * Pass mb2_substr_count() a $needle that overlaps in $haystack and see whether
...
var_dump(mb2_substr_count($string_ascii, b'abcabc')); //needle overlaps in haystack

echo "\n-- Multibyte String --\n";
$string_mb = base64_decode('5pel5pys6Kqe5pel5pys6Kqe5pel5pys6Kqe');
$needle_mb = base64_decode('5pel5pys6Kqe5pel5pys6Kqe');
var_dump(mb2_substr_count($string_mb, $needle_mb, 'utf-8'));
